...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        // ----------------------------------------------------------------------------------- //
        KC_NO, KC_LALT, KC_LCMD, KC_SPC, LT(_LOWER, KC_ESC), /* --- */ LT(_RAISE, KC_ENT), KC_BSPC, RSFT_T(KC_RCMD), KC_NO, KC_NO
    ),
    [_LOWER] = LAYOUT(
        ...
        // ----------------------------------------------------------------------------------- //
        KC_NO, KC_LALT, KC_LCMD, KC_SPC, MO(_ADJUST), /* --- */ KC_BSPC, KC_RSFT, KC_RCTL, KC_NO, KC_NO
    ),
    [_RAISE] = LAYOUT(

...
enum custom_keycodes {
 ...
 const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
         ...
         KC_GRV, KC_NO, KC_LALT, KC_LGUI, KC_SPC, LT(_LOWER,KC_ESC), LT(_RAISE,KC_ENT), KC_BSPC, KC_RSFT, KC_RCTL, KC_NO),
	[_LOWER] = LAYOUT(
        ...
        KC_TAB, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_F12,
         ...
         KC_LCTL, KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_NO, KC_NO, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, KC_PSLS,
         KC_NO, KC_LALT, KC_LGUI, KC_SPC, MO(_ADJUST), MO(_ADJUST), KC_BSPC, KC_RSFT, KC_RCTL, KC_NO),
	[_RAISE] = LAYOUT(
         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
         KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_COPY, KC_NO, KC_NO, KC_NO, KC_PSTE, KC_NO,
         KC_LSFT, KC_NO, KC_NO, KC_CUT, KC_LALT, KC_LGUI, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO,
         KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
         KC_NO, KC_LALT, KC_LGUI, KC_SPC, MO(_ADJUST), MO(_ADJUST), KC_BSPC, KC_RSFT, KC_RCTL, KC_NO),
	[_ADJUST] = LAYOUT(
         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 0x7f, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
         KC_NO, 0x49, 0x48, 0x47, KC_NO, KC_NO, 0x81, 0x80, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, /* --- */ KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RCTL(OSM(KC_RALT)),
        // ----------------------------------------------------------------------------------- //
        KC_NO, KC_LALT, KC_LCMD, KC_SPC, LT(_LOWER, KC_ESC), /* --- */ LT(_RAISE, KC_ENT), KC_BSPC, RSFT_T(OSM(KC_RCMD)), KC_NO, KC_NO
    ),
    [_LOWER] = LAYOUT(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, /* --- */ KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
        KC_TAB, KC_1, KC_2, KC_3, KC_4, KC_5, /* --- */ KC_6, KC_7, KC_8, KC_9, KC_0, KC_F12,
        LSFT_T(KC_ESC), KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, /* --- */ KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
        MO(_NUMPAD), KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_NO, /* --- */ KC_NO, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, KC_PSLS,
        // ----------------------------------------------------------------------------------- //
        KC_NO, KC_LALT, KC_LCMD, KC_SPC, MO(_ADJUST), /* --- */ MO(_ADJUST), KC_BSPC, KC_RSFT, KC_RCTL, KC_NO
    ),
    [_RAISE] = LAYOUT(
